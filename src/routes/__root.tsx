...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover, validate, launch, operate and grow brick-and-mortar businesses with AI-powered intelligence." },
      { property: "og:title", content: "Found-r — Clarity Before Commitment" },
      { property: "og:description", content: "The AI-powered operating system for prospective and existing business owners." },
